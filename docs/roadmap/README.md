...
| Ubuntu/Debian + GRUB + EFI | Supported for detected layouts; apt/dpkg hooks not implemented |
...
1. Harden Ubuntu/Debian + GRUB support and add a release-gate VM scenario.
